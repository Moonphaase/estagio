...
class APIKey(models.Model):
    ...
    key_full = models.CharField(max_length=64, unique=True)   # chave completa, em texto simples
    key_prefix = models.CharField(max_length=8, unique=True)  # primeiros 8 chars (para exibição/listagem)
    key_hash = models.CharField(max_length=64, unique=True, null=True, blank=True)  # mantido por compatibilidade, opcional
