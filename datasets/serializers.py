...
class DatasetMetadataSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ["source", "license", "tags", "language", "size_bytes", "num_records", "extra", "updated_at"]
        read_only_fields = ["updated_at"]

class DatasetVersionSerializer(serializers.ModelSerializer):
    created_by = serializers.StringRelatedField(read_only=True)
    file_url = serializers.SerializerMethodField(help_text="URL absoluta para download do ficheiro")
...
class DatasetSerializer(serializers.ModelSerializer):
    ...
    metadata = DatasetMetadataSerializer(required=False)
...
class DatasetListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "owner", "visibility", "status", "version_count", "latest_version",
            "is_favorited", "created_at", "updated_at",
        ]
        read_only_fields = ["id", "slug", "owner", "created_at", "updated_at"]
